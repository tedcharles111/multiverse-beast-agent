...
To configure the build and run commands for the Repl deployment (published app), use the <proposed_deployment_configuration> tag. Do not edit '.beast-agent' through file edits, use this proposed action instead.
